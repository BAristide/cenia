...
public class WSSendEmailSurvey {
	    ...
	    public void sendMailWebService(long id, long issId, String periodx, String recepient, String object, String serviceName, String dateFin) {
	    	 String linkRedirect = "http://localhost:8081/userSurvey?uId="+id+"&isId="+issId+"&period="+periodx+"";
        ...
        //  .withEmailAddressCriteria(EmailAddressCriteria.DEFAULT)      
          ...
          .withHTMLText("<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"https://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\r\n" + 
          		...
          		"              <tbody><tr>\r\n" + 
          		"                <td style=\"font-family:'Open Sans', Arial, sans-serif; font-size:12px; line-height:15px; color:#0d1121;\" valign=\"top\" align=\"center\">Enquête sur gestion de l'incident| " +serviceName+ "+</td>\r\n" + 
          		"              </tr>\r\n" + 
          		"            </tbody></table></td>\r\n" + 
          		"        </tr>\r\n" + 
          		"        <!--//Header section--> \r\n" + 
          		...
          		"				Nous vous prions de bien vouloir vous soumettre à une énquete sur la gestion de l'incident sur "+serviceName+" <br>\r\n" + 
          		"				\r\n" + 
          		"				Pour participer à cliquer veuilez cliquer  <a href=\""+linkRedirect+"\" target=\"_blank\" style=\"color:#0d1121; text-decoration:underline;\">ICI</a></td>\r\n" + 
          		"              </tr>\r\n" + 
          		"              <tr>\r\n" + 
          		...
          		"<tr>\r\n" + 
          		"                <td style=\"font-family:'Open Sans', Arial, sans-serif; font-size:18px; line-height:22px; color:#0d1121; letter-spacing:2px; padding-bottom:12px;\" valign=\"top\"  >\r\n" + 
          		"				Date de fin de l'enquete: "+ dateFin+"</td>\r\n" + 
          		"              </tr>\r\n" + 
          		"            </tbody></table></td>\r\n" + 
          		"        </tr>\r\n" + 
          		"\r\n" + 
