...
public class WSSendEmailAvcMent {
	
	
	
	  public  void sendMailWebService(String recepient, String object, String serviceName,String avcMent, String dateFin ) { 
	      
		  sendMailNoProxyFromLinksGuardDomaine(recepient, object,serviceName,avcMent, dateFin );
	    }
	    ...
	    private void sendMailNoProxyFromLinksGuardDomaine(String recepient, String object, String serviceName,String avcMent, String dateFin) {
        ...
        //  .withEmailAddressCriteria(EmailAddressCriteria.DEFAULT)      
          ...
          .withHTMLText("<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"https://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\r\n" + 
          		...
          		"              <tbody><tr>\r\n" + 
          		"                <td style=\"font-family:'Open Sans', Arial, sans-serif; font-size:12px; line-height:15px; color:#0d1121;\" valign=\"top\" align=\"center\">Etat d'avencement sur l'incident sur | "+serviceName+"</td>\r\n" + 
          		"              </tr>\r\n" + 
          		"            </tbody></table></td>\r\n" + 
          		"        </tr>\r\n" + 
          		"        <!--//Header section--> \r\n" + 
