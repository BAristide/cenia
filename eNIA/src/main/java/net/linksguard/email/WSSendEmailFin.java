...
public class WSSendEmailFin {
	
	
	
	  public  void sendMailWebService(String recepient, String object, String serviceName, String cause, String dateFin ) { 
	      
		  sendMailNoProxyFromLinksGuardDomaine(recepient, object,serviceName, cause,dateFin );
	    }
	    ...
	    private void sendMailNoProxyFromLinksGuardDomaine(String recepient, String object, String serviceName, String cause, String dateFin) {
        ...
        //  .withEmailAddressCriteria(EmailAddressCriteria.DEFAULT)      
          ...
          .withHTMLText("<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"https://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\r\n" + 
          		...
          		"              <tbody><tr>\r\n" + 
          		"                <td style=\"font-family:'Open Sans', Arial, sans-serif; font-size:12px; line-height:15px; color:#0d1121;\" valign=\"top\" align=\"center\">Fin d'incident sur la plateforme | "+serviceName+"</td>\r\n" + 
          		"              </tr>\r\n" + 
          		"            </tbody></table></td>\r\n" + 
          		"        </tr>\r\n" + 
          		"        <!--//Header section--> \r\n" + 
          		...
          		"<tr>\r\n" + 
          		"                <td style=\"font-family:'Open Sans', Arial, sans-serif; font-size:18px; line-height:22px; color:#0d1121; letter-spacing:2px; padding-bottom:12px;\" valign=\"top\"  >\r\n" + 
          		"				Délai final de résolution: "+dateFin+"</td>\r\n" + 
          		"              </tr>\r\n" + 
          		"            </tbody></table></td>\r\n" + 
          		"        </tr>\r\n" + 
          		"\r\n" + 
