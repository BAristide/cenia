...
import net.linksguard.storage.StorageFileNotFoundException;
import net.linksguard.storage.StorageService;
...
public class FileUploadController {
    ...
    public String handleFileUpload(@Validated MultipartFileBucket multipartFileBucket, BindingResult result, Model model) {
